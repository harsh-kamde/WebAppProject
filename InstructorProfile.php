...
$instructor_id = $_COOKIE['instructor_id']; // Assuming user_id is passed as a query parameter in the URL
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted text-center">Instructor</h6>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p><span class="font-weight-bold">Account:&nbsp;</span><?php echo $account_no; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p><span class="font-weight-bold">IFSC code:&nbsp;</span><?php echo $IFSC_Code; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 text-end">
                            <a href="EditUserProfile.php?user_id='user1'"><button type="button" class="btn btn-primary">Edit Profile</button></a>
                        </div>
                    </div>
                </div>
            </div>
